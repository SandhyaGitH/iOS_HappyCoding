     ...
     */
       ...
       // appDelecate.UpdateCart(<#T##cart: ECart##ECart#>, <#T##vprod: ProdToOrder##ProdToOrder#>, <#T##TotalintoCart: Int##Int#>, <#T##Cust: ECustomer##ECustomer#>)
        ...
        if(loginCust.cart != nil)
        {
           ...
           /* for item in loginCust.cart?.products as {
                let q = item.av
                appDelecate.updateRecord(<#T##cust: ECustomer##ECustomer#>, <#T##fn: String##String#>, <#T##ln: String##String#>, <#T##add: String##String#>, <#T##email: String##String#>, <#T##pho: String##String#>)
            } */
        }
